...
step1_source = [
    ...
    "",
    "# Intento de clonación con rama específica",
    "clone_cmd = f\"git clone -b {BRANCH} {clone_url} {target_dir}\"",
    "if os.system(clone_cmd) != 0:",
    "    print(f\"⚠️ Error al clonar rama '{BRANCH}'. Intentando rama por defecto...\")",
    "    if os.system(f\"git clone {clone_url} {target_dir}\") != 0:",
    "        raise Exception(\"Fallo crítico al clonar el repositorio.\")",
    "",
    "os.chdir(target_dir)",
    "",
