...
step1_source = [
    ...
    "",
    "print(\"🧹 Eliminando binarios antiguos de Ollama si existen...\")",
    "os.system(\"rm -f /usr/local/bin/ollama /usr/bin/ollama\")",
    "",
    ...
    "os.system(f\"{ollama_bin} pull llama3:8b\")",
    "",
    "print(\"🔍 Verificando estado y modelos de Ollama...\")",
    "import urllib.request",
    "import json",
    "try:",
    "    with urllib.request.urlopen(\"http://127.0.0.1:11434/api/tags\") as resp:",
    "        tags = json.loads(resp.read().decode())",
    "        models = [m['name'] for m in tags.get('models', [])]",
    "        print(f\"✅ Ollama respondiendo en puerto 11434. Modelos listos: {models}\")",
    "except Exception as e:",
    "    print(f\"❌ Alerta: No se pudo verificar Ollama local: {e}\")",
    "",
    ...
    "        print(\"🔑 GEMINI_API_KEY detectada en Colab Secrets y agregada a .env.\")",
    "except Exception:",
    "    pass",
    "",
...
step2_source = [
    ...
    "",
    "print(\"🧹 Limpiando procesos de servidores y túneles anteriores...\")",
    "os.system(\"fuser -k 3000/tcp 2>/dev/null || true\")",
    "os.system(\"pkill -f cloudflared || true\")",
    "os.system(\"pkill -f 'next-server' || true\")",
    "",
    "target_dir = \"/content/MuniGestio\"",
    "os.chdir(target_dir)",
    "",
